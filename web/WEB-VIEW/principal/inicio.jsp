...
<html>
	...
	<div class=" text-center ">
            <img height="360" width="220" src="<c:url value="/pages/images/logo.png" />" class="img-responsive center-block m" alt="RS - Locacao de Veiculos">
            <h1 class="cover-heading">Sistema de Gestao da RS Carros.</h1>
            <p class="lead">De militar para militar, agil e sem burocracia!.</p>
	</div>
    </div>
    </section>
